...
def load_data(args, device):
    ...
    for i in range(features.shape[1]):
        ...
        if os.path.exists(direction_judge):
            ...
            adj, _ = construct_adjacency_matrix(feature, args.knns, args.pr1, args.pr2, args.common_neighbors)
    ...
    return feature_list, adj_list, labels, idx_labeled, idx_unlabeled, adj_hats_list
